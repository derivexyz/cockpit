...
/**{
  ...
  "allOf": [
    {
      "$ref": "#/definitions/PrivateGetOrdersJSONRPCSchema"
    }
  ]
}*/
/// ```
/// </details>
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct PrivateGetOrders(pub PrivateGetOrdersJsonrpcSchema);
impl std::ops::Deref for PrivateGetOrders {
    type Target = PrivateGetOrdersJsonrpcSchema;
    fn deref(&self) -> &PrivateGetOrdersJsonrpcSchema {
        &self.0
    }
}
impl From<PrivateGetOrders> for PrivateGetOrdersJsonrpcSchema {
    fn from(value: PrivateGetOrders) -> Self {
        value.0
    }
}
impl From<&PrivateGetOrders> for PrivateGetOrders {
    fn from(value: &PrivateGetOrders) -> Self {
        value.clone()
    }
}
impl From<PrivateGetOrdersJsonrpcSchema> for PrivateGetOrders {
    fn from(value: PrivateGetOrdersJsonrpcSchema) -> Self {
        Self(value)
    }
}
///PrivateGetOrdersJsonrpcSchema
///
/// <details><summary>JSON schema</summary>
///
/// ```json
/**{
  ...
  "properties": {
    "request": {
      "type": "object",
      "$ref": "#/definitions/PrivateGetOrdersRequestSchema",
      "field_many": false
    },
    "response": {
      "type": "object",
      "$ref": "#/definitions/PrivateGetOrdersResponseSchema",
      "field_many": false
    }
  },
  "additionalProperties": false
...
pub struct PrivateGetOrdersJsonrpcSchema {
    pub request: PrivateGetOrdersRequestSchema,
    pub response: PrivateGetOrdersResponseSchema,
}
impl From<&PrivateGetOrdersJsonrpcSchema> for PrivateGetOrdersJsonrpcSchema {
    fn from(value: &PrivateGetOrdersJsonrpcSchema) -> Self {
        value.clone()
    }
}
...
pub struct PrivateGetOrdersParamsSchema {
...
impl From<&PrivateGetOrdersParamsSchema> for PrivateGetOrdersParamsSchema {
    fn from(value: &PrivateGetOrdersParamsSchema) -> Self {
        value.clone()
    }
}
///PrivateGetOrdersRequestSchema
///
/// <details><summary>JSON schema</summary>
///
/// ```json
/**{
  ...
  "properties": {
    ...
    "method": {
      "title": "method",
      "type": "string",
      "const": "private/get_orders"
    },
    "params": {
      "type": "object",
      "$ref": "#/definitions/PrivateGetOrdersParamsSchema",
      "field_many": false
    }
  },
  "additionalProperties": false
...
pub struct PrivateGetOrdersRequestSchema {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<PrivateGetOrdersRequestSchemaId>,
    pub method: String,
    pub params: PrivateGetOrdersParamsSchema,
}
impl From<&PrivateGetOrdersRequestSchema> for PrivateGetOrdersRequestSchema {
    fn from(value: &PrivateGetOrdersRequestSchema) -> Self {
        value.clone()
    }
}
///PrivateGetOrdersRequestSchemaId
///
/// <details><summary>JSON schema</summary>
///
/// ```json
...
#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(untagged)]
pub enum PrivateGetOrdersRequestSchemaId {
    Variant0(String),
    Variant1(i64),
}
impl From<&PrivateGetOrdersRequestSchemaId> for PrivateGetOrdersRequestSchemaId {
    fn from(value: &PrivateGetOrdersRequestSchemaId) -> Self {
        value.clone()
    }
}
impl std::str::FromStr for PrivateGetOrdersRequestSchemaId {
    type Err = &'static str;
    fn from_str(value: &str) -> Result<Self, &'static str> {
...
impl std::convert::TryFrom<&str> for PrivateGetOrdersRequestSchemaId {
    type Error = &'static str;
    fn try_from(value: &str) -> Result<Self, &'static str> {
        value.parse()
    }
}
impl std::convert::TryFrom<&String> for PrivateGetOrdersRequestSchemaId {
    type Error = &'static str;
    fn try_from(value: &String) -> Result<Self, &'static str> {
        value.parse()
    }
...
impl ToString for PrivateGetOrdersRequestSchemaId {
    fn to_string(&self) -> String {
        match self {
...
impl From<i64> for PrivateGetOrdersRequestSchemaId {
...
/**{
  ...
  "properties": {
    ...
    "result": {
      "description": "",
      "type": "object",
      "$ref": "#/definitions/PrivateGetOrdersResultSchema",
      "field_many": false
    }
  },
  "additionalProperties": false
...
pub struct PrivateGetOrdersResponseSchema {
    pub id: PrivateGetOrdersResponseSchemaId,
    ///
    pub result: PrivateGetOrdersResultSchema,
}
impl From<&PrivateGetOrdersResponseSchema> for PrivateGetOrdersResponseSchema {
    fn from(value: &PrivateGetOrdersResponseSchema) -> Self {
        value.clone()
    }
}
///PrivateGetOrdersResponseSchemaId
///
/// <details><summary>JSON schema</summary>
///
/// ```json
...
#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(untagged)]
pub enum PrivateGetOrdersResponseSchemaId {
    Variant0(String),
    Variant1(i64),
}
impl From<&PrivateGetOrdersResponseSchemaId> for PrivateGetOrdersResponseSchemaId {
    fn from(value: &PrivateGetOrdersResponseSchemaId) -> Self {
        value.clone()
    }
}
impl std::str::FromStr for PrivateGetOrdersResponseSchemaId {
    type Err = &'static str;
    fn from_str(value: &str) -> Result<Self, &'static str> {
        if let Ok(v) = value.parse() {
            Ok(Self::Variant0(v))
...
impl std::convert::TryFrom<&str> for PrivateGetOrdersResponseSchemaId {
    type Error = &'static str;
    fn try_from(value: &str) -> Result<Self, &'static str> {
        value.parse()
    }
}
impl std::convert::TryFrom<&String> for PrivateGetOrdersResponseSchemaId {
    type Error = &'static str;
    fn try_from(value: &String) -> Result<Self, &'static str> {
        value.parse()
    }
...
impl ToString for PrivateGetOrdersResponseSchemaId {
    fn to_string(&self) -> String {
        match self {
            Self::Variant0(x) => x.to_string(),
            Self::Variant1(x) => x.to_string(),
...
impl From<i64> for PrivateGetOrdersResponseSchemaId {
    fn from(value: i64) -> Self {
        Self::Variant1(value)
    }
}
...
pub struct PrivateGetOrdersResultSchema {
    ///List of open orders
...
impl From<&PrivateGetOrdersResultSchema> for PrivateGetOrdersResultSchema {
    fn from(value: &PrivateGetOrdersResultSchema) -> Self {
        value.clone()
    }
}
///Filter by order status
