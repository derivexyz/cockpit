...
/**{
  ...
  "allOf": [
    {
      "$ref": "#/definitions/SubaccountIdQuotesPubSubSchema"
    }
  ]
}*/
/// ```
/// </details>
#[derive(Clone, Debug, Deserialize, Serialize)]
pub struct SubaccountIdQuotes(pub SubaccountIdQuotesPubSubSchema);
impl std::ops::Deref for SubaccountIdQuotes {
    type Target = SubaccountIdQuotesPubSubSchema;
    fn deref(&self) -> &SubaccountIdQuotesPubSubSchema {
        &self.0
    }
}
impl From<SubaccountIdQuotes> for SubaccountIdQuotesPubSubSchema {
    fn from(value: SubaccountIdQuotes) -> Self {
        value.0
    }
}
impl From<&SubaccountIdQuotes> for SubaccountIdQuotes {
    fn from(value: &SubaccountIdQuotes) -> Self {
        value.clone()
    }
}
impl From<SubaccountIdQuotesPubSubSchema> for SubaccountIdQuotes {
    fn from(value: SubaccountIdQuotesPubSubSchema) -> Self {
        Self(value)
    }
}
///SubaccountIdQuotesChannelSchema
///
/// <details><summary>JSON schema</summary>
///
/// ```json
/**{
  ...
  "properties": {
    "subaccount_id": {
      "title": "subaccount_id",
      "description": "Subaccount ID to get quote state updates for",
      "type": "integer"
    }
  },
  "additionalProperties": false
...
pub struct SubaccountIdQuotesChannelSchema {
    ///Subaccount ID to get quote state updates for
    pub subaccount_id: i64,
}
impl From<&SubaccountIdQuotesChannelSchema> for SubaccountIdQuotesChannelSchema {
    fn from(value: &SubaccountIdQuotesChannelSchema) -> Self {
        value.clone()
    }
}
///SubaccountIdQuotesNotificationParamsSchema
///
/// <details><summary>JSON schema</summary>
///
/// ```json
...
///SubaccountIdQuotesNotificationSchema
///
/// <details><summary>JSON schema</summary>
///
/// ```json
/**{
  ...
  "properties": {
    ...
    "params": {
      "type": "object",
      "$ref": "#/definitions/SubaccountIdQuotesNotificationParamsSchema",
      "field_many": false
    }
  },
  "additionalProperties": false
...
///SubaccountIdQuotesPubSubSchema
///
/// <details><summary>JSON schema</summary>
///
/// ```json
/**{
  ...
  "properties": {
    "channel_params": {
      "type": "object",
      "$ref": "#/definitions/SubaccountIdQuotesChannelSchema",
      "field_many": false
    },
    "notification": {
      "type": "object",
      "$ref": "#/definitions/SubaccountIdQuotesNotificationSchema",
      "field_many": false
    }
  },
  "additionalProperties": false
...
pub struct SubaccountIdQuotesPubSubSchema {
    pub channel_params: SubaccountIdQuotesChannelSchema,
    pub notification: SubaccountIdQuotesNotificationSchema,
}
impl From<&SubaccountIdQuotesPubSubSchema> for SubaccountIdQuotesPubSubSchema {
    fn from(value: &SubaccountIdQuotesPubSubSchema) -> Self {
        value.clone()
    }
}
