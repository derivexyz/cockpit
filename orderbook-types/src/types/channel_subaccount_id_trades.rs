...
/**{
  ...
  "description": "Subscribe to user's trades (order executions) for a given subaccount ID.",
  "type": "object",
  "allOf": [
    {
      "$ref": "#/definitions/SubaccountIdTradesPubSubSchema"
    }
  ]
}*/
/// ```
...
pub struct SubaccountIdTrades(pub SubaccountIdTradesPubSubSchema);
impl std::ops::Deref for SubaccountIdTrades {
    type Target = SubaccountIdTradesPubSubSchema;
    fn deref(&self) -> &SubaccountIdTradesPubSubSchema {
        &self.0
    }
}
impl From<SubaccountIdTrades> for SubaccountIdTradesPubSubSchema {
    fn from(value: SubaccountIdTrades) -> Self {
        value.0
    }
}
impl From<&SubaccountIdTrades> for SubaccountIdTrades {
    fn from(value: &SubaccountIdTrades) -> Self {
        value.clone()
    }
}
impl From<SubaccountIdTradesPubSubSchema> for SubaccountIdTrades {
    fn from(value: SubaccountIdTradesPubSubSchema) -> Self {
        Self(value)
    }
}
///SubaccountIdTradesChannelSchema
///
/// <details><summary>JSON schema</summary>
///
/// ```json
...
pub struct SubaccountIdTradesChannelSchema {
    ///Subaccount ID
    pub subaccount_id: i64,
}
impl From<&SubaccountIdTradesChannelSchema> for SubaccountIdTradesChannelSchema {
    fn from(value: &SubaccountIdTradesChannelSchema) -> Self {
        value.clone()
    }
}
///SubaccountIdTradesNotificationParamsSchema
///
/// <details><summary>JSON schema</summary>
///
/// ```json
...
pub struct SubaccountIdTradesNotificationParamsSchema {
...
///SubaccountIdTradesNotificationSchema
///
/// <details><summary>JSON schema</summary>
///
/// ```json
/**{
  ...
  "properties": {
    ...
    "params": {
      "type": "object",
      "$ref": "#/definitions/SubaccountIdTradesNotificationParamsSchema",
      "field_many": false
    }
  },
  "additionalProperties": false
...
pub struct SubaccountIdTradesNotificationSchema {
    pub method: String,
...
///SubaccountIdTradesPubSubSchema
///
/// <details><summary>JSON schema</summary>
///
/// ```json
/**{
  ...
  "properties": {
    "channel_params": {
      "type": "object",
      "$ref": "#/definitions/SubaccountIdTradesChannelSchema",
      "field_many": false
    },
    "notification": {
      "type": "object",
      "$ref": "#/definitions/SubaccountIdTradesNotificationSchema",
      "field_many": false
    }
  },
  "additionalProperties": false
...
pub struct SubaccountIdTradesPubSubSchema {
    pub channel_params: SubaccountIdTradesChannelSchema,
    pub notification: SubaccountIdTradesNotificationSchema,
}
impl From<&SubaccountIdTradesPubSubSchema> for SubaccountIdTradesPubSubSchema {
    fn from(value: &SubaccountIdTradesPubSubSchema) -> Self {
        value.clone()
    }
}
