...
/**{
  ...
  "allOf": [
    {
      "$ref": "#/definitions/PrivateGetOrderJSONRPCSchema"
    }
  ]
}*/
/// ```
...
pub struct PrivateGetOrder(pub PrivateGetOrderJsonrpcSchema);
impl std::ops::Deref for PrivateGetOrder {
    type Target = PrivateGetOrderJsonrpcSchema;
    fn deref(&self) -> &PrivateGetOrderJsonrpcSchema {
        &self.0
    }
}
impl From<PrivateGetOrder> for PrivateGetOrderJsonrpcSchema {
    fn from(value: PrivateGetOrder) -> Self {
        value.0
    }
}
impl From<&PrivateGetOrder> for PrivateGetOrder {
    fn from(value: &PrivateGetOrder) -> Self {
        value.clone()
    }
}
impl From<PrivateGetOrderJsonrpcSchema> for PrivateGetOrder {
    fn from(value: PrivateGetOrderJsonrpcSchema) -> Self {
        Self(value)
    }
}
///PrivateGetOrderJsonrpcSchema
///
/// <details><summary>JSON schema</summary>
///
/// ```json
/**{
  ...
  "properties": {
    "request": {
      "type": "object",
      "$ref": "#/definitions/PrivateGetOrderRequestSchema",
      "field_many": false
    },
    "response": {
      "type": "object",
      "$ref": "#/definitions/PrivateGetOrderResponseSchema",
      "field_many": false
    }
  },
...
pub struct PrivateGetOrderJsonrpcSchema {
    pub request: PrivateGetOrderRequestSchema,
    pub response: PrivateGetOrderResponseSchema,
}
impl From<&PrivateGetOrderJsonrpcSchema> for PrivateGetOrderJsonrpcSchema {
    fn from(value: &PrivateGetOrderJsonrpcSchema) -> Self {
        value.clone()
    }
}
...
pub struct PrivateGetOrderParamsSchema {
    ///Order ID
    pub order_id: String,
    ///Subaccount ID
    pub subaccount_id: i64,
}
impl From<&PrivateGetOrderParamsSchema> for PrivateGetOrderParamsSchema {
    fn from(value: &PrivateGetOrderParamsSchema) -> Self {
        value.clone()
    }
}
///PrivateGetOrderRequestSchema
///
/// <details><summary>JSON schema</summary>
///
/// ```json
/**{
  ...
  "properties": {
    ...
    "method": {
      "title": "method",
      "type": "string",
      "const": "private/get_order"
    },
    "params": {
      "type": "object",
      "$ref": "#/definitions/PrivateGetOrderParamsSchema",
      "field_many": false
    }
  },
  "additionalProperties": false
...
pub struct PrivateGetOrderRequestSchema {
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<PrivateGetOrderRequestSchemaId>,
    pub method: String,
    pub params: PrivateGetOrderParamsSchema,
}
impl From<&PrivateGetOrderRequestSchema> for PrivateGetOrderRequestSchema {
    fn from(value: &PrivateGetOrderRequestSchema) -> Self {
        value.clone()
    }
}
///PrivateGetOrderRequestSchemaId
///
/// <details><summary>JSON schema</summary>
///
/// ```json
...
#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(untagged)]
pub enum PrivateGetOrderRequestSchemaId {
    Variant0(String),
    Variant1(i64),
}
impl From<&PrivateGetOrderRequestSchemaId> for PrivateGetOrderRequestSchemaId {
    fn from(value: &PrivateGetOrderRequestSchemaId) -> Self {
        value.clone()
    }
}
impl std::str::FromStr for PrivateGetOrderRequestSchemaId {
    type Err = &'static str;
    fn from_str(value: &str) -> Result<Self, &'static str> {
...
impl std::convert::TryFrom<&str> for PrivateGetOrderRequestSchemaId {
    type Error = &'static str;
    fn try_from(value: &str) -> Result<Self, &'static str> {
        value.parse()
    }
}
impl std::convert::TryFrom<&String> for PrivateGetOrderRequestSchemaId {
    type Error = &'static str;
    fn try_from(value: &String) -> Result<Self, &'static str> {
        value.parse()
    }
...
impl ToString for PrivateGetOrderRequestSchemaId {
    fn to_string(&self) -> String {
        match self {
...
impl From<i64> for PrivateGetOrderRequestSchemaId {
...
/**{
  ...
  "properties": {
    ...
    "result": {
      "description": "",
      "type": "object",
      "$ref": "#/definitions/PrivateGetOrderResultSchema",
      "field_many": false
    }
  },
  "additionalProperties": false
...
pub struct PrivateGetOrderResponseSchema {
    pub id: PrivateGetOrderResponseSchemaId,
    ///
    pub result: PrivateGetOrderResultSchema,
}
impl From<&PrivateGetOrderResponseSchema> for PrivateGetOrderResponseSchema {
    fn from(value: &PrivateGetOrderResponseSchema) -> Self {
        value.clone()
    }
}
///PrivateGetOrderResponseSchemaId
///
/// <details><summary>JSON schema</summary>
///
/// ```json
...
#[derive(Clone, Debug, Deserialize, Serialize)]
#[serde(untagged)]
pub enum PrivateGetOrderResponseSchemaId {
    Variant0(String),
    Variant1(i64),
}
impl From<&PrivateGetOrderResponseSchemaId> for PrivateGetOrderResponseSchemaId {
    fn from(value: &PrivateGetOrderResponseSchemaId) -> Self {
        value.clone()
    }
}
impl std::str::FromStr for PrivateGetOrderResponseSchemaId {
    type Err = &'static str;
    fn from_str(value: &str) -> Result<Self, &'static str> {
        if let Ok(v) = value.parse() {
            Ok(Self::Variant0(v))
...
impl std::convert::TryFrom<&str> for PrivateGetOrderResponseSchemaId {
    type Error = &'static str;
    fn try_from(value: &str) -> Result<Self, &'static str> {
        value.parse()
    }
}
impl std::convert::TryFrom<&String> for PrivateGetOrderResponseSchemaId {
    type Error = &'static str;
    fn try_from(value: &String) -> Result<Self, &'static str> {
        value.parse()
    }
...
impl ToString for PrivateGetOrderResponseSchemaId {
    fn to_string(&self) -> String {
        match self {
            Self::Variant0(x) => x.to_string(),
            Self::Variant1(x) => x.to_string(),
...
impl From<i64> for PrivateGetOrderResponseSchemaId {
    fn from(value: i64) -> Self {
        Self::Variant1(value)
    }
}
...
pub struct PrivateGetOrderResultSchema {
...
impl From<&PrivateGetOrderResultSchema> for PrivateGetOrderResultSchema {
    fn from(value: &PrivateGetOrderResultSchema) -> Self {
        value.clone()
    }
}
///Time in force
