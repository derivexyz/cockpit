...
impl ActionData {
    pub fn to_order_params(
        ...
        Ok(OrderParams {
            ...
            reject_timestamp: Some(
                (chrono::Utc::now() + chrono::Duration::milliseconds(reject_millis)).timestamp_millis(),
            ),
            ...
            is_atomic_signing: Some(is_atomic_signing),
            reject_post_only: Some(reject_post_only),
            trigger_type: None,
